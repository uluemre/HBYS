...
export const Sidebar = ({ rol, aktifSekme, setAktifSekme, logout }) => {
  const menuMap = {
    ...
    DOKTOR: [
      { name: "Ana Sayfa", icon: "🏠" },
      { name: "Doktor Bilgileri", icon: "👨‍⚕️" },
      { name: "Randevularım", icon: "📅" },
      { name: "Muayene Süreçleri", icon: "🩺" },
      { name: "Çalışma Takvimi", icon: "🗓️" },
      { name: "Personel", icon: "👥" },
      { name: "Otopark Durumu", icon: "🅿️" },
      { name: "Şikayet/Öneri", icon: "📩" }
    ],
    ...
    BASHEKIM: [
      { name: "Ana Sayfa", icon: "🏠" },
      { name: "Başhekim Profili", icon: "👨‍💼" },
      { name: "Randevularım", icon: "📅" },
      { name: "Personel", icon: "👥" },
      { name: "Şikayet/Öneri Yönetimi", icon: "📝" },
      { name: "Nöbet ve Çalışma Çizelgesi", icon: "🗓️" },
      { name: "Performans Analizi", icon: "📊" },
      { name: "Otopark Durumu", icon: "🅿️" }
    ],
  ...
  const menuItems = menuMap[rol] || [{ name: "Ana Sayfa", icon: "🏠" }];
